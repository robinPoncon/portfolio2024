			...
			<article className="flex flex-col gap-14">
				<div className="text-center">
					...
					<ul className="flex flex-col gap-2 italic">
						<li
							className={
								isActiveLink(["/en", "/fr"]) ? "text-customVioletLighter" : ""
							}
						>
				...
				<div className="text-center">
					...
					<div className="flex flex-col gap-2 italic">
						...
						<p>
							Email :{" "}
							<a href="mailto:poncon.robin@gmail.com">poncon.robin@gmail.com</a>
						</p>
						<a
							href="/CV_Robin-Poncon_2024.pdf"
							className="flex gap-1 justify-center w-fit mx-auto"
						...
						>
							...
							<Image
								...
								src="/icons/download-document_icon.svg"
								height={24}
								width={24}
							/>
						</a>
